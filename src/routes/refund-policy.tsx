    ...
    <div className="min-h-screen flex flex-col bg-slate-50/50">
      ...
      <main className="container mx-auto px-4 py-20 max-w-4xl flex-1">
        <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-soft border border-border/50">
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight mb-2">Refund & Cancellation Policy</h1>
          ...
          <div className="space-y-8 text-slate-600 leading-relaxed">
            <div className="p-4 bg-red-50 border border-red-100 rounded-xl text-red-800">
              <h2 className="text-lg font-bold mb-1">Important Rule: No Refunds After Confirmation</h2>
              <p className="text-sm">
                Once a seat booking is confirmed and payment is completed, <strong>we do not offer any refunds</strong>. Please review your travel details, pickup location, and driver information carefully before completing your reservation.
              </p>
            </div>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                ...
                <li>The ride host fails to show up at the designated pickup location at the agreed-upon time.</li>
                <li>Significant safety concerns are reported and verified prior to the start of the journey.</li>
              </ul>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 mb-3">2. Failed Transaction Handling</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 mb-3">3. Duplicate Payment Handling</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 mb-3">4. Refund Timelines (Platform Issues)</h2>
              <p>
            ...
            <section className="pt-6 border-t border-border/60">
              ...
              <p>
                For payment disputes or cancellation issues, please reach out immediately:<br/>
