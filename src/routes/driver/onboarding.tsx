    ...
    <div className="min-h-screen bg-gradient-hero flex">
      ...
      <div className="hidden lg:flex lg:w-[420px] xl:w-[480px] flex-col justify-between p-10 bg-gradient-to-br from-violet-700 via-purple-700 to-indigo-800 relative overflow-hidden shrink-0">
        ...
        <div className="relative z-10">
          <div className="flex items-center mb-16">
            <img src={logo} alt="Coolpool Logo" className="h-16 w-auto object-contain mix-blend-multiply" />
          </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <div className="lg:hidden flex items-center px-5 pt-6 pb-4">
          <img src={logo} alt="Coolpool Logo" className="h-10 w-auto object-contain mix-blend-multiply" />
        </div>
